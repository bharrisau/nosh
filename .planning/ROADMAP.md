...
- [ ] **Phase 4: Identity Threading** — Wire `Session.identity` from the authenticated TLS handshake (fills the deliberate v1.0 seam)
...
| 4. Identity Threading | v1.1 | 0/? | Not started | - |
